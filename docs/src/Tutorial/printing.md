...
expression.  It will be discussed more in the [tutorial-manipulation](tutorial-manipulation)
...
[tutorial-manipulation](tutorial-manipulation) section for some examples of the output of this
printer.
