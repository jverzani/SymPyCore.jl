...
Base.promote_op(::O, ::Type{Sym{T}}, ::Type{Sym{T}}) where {P,T} = Sym{T} # This helps out linear alg

call_matrix_meth(M::Matrix{T}, meth::Symbol, args...; kwargs...) where {T <: SymbolicObject} =
