...
function integer_elements(M::Array{T,2}) where {T <: SymPy.Sym}
    ...
    invertible::Function   = (x::Array{<:Sym,2}) -> ↑((_sympy_.Matrix((↓).(x))).XXX())
    singular::Function     = (x::Array{<:Sym,2}) -> ↑((_sympy_.Matrix((↓).(x))).XXX())
    orthogonal::Function   = (x::Array{<:Sym,2}) -> ↑((_sympy_.Matrix((↓).(x))).XXX())
    unitary::Function      = (x::Array{<:Sym,2}) -> ↑((_sympy_.Matrix((↓).(x))).XXX())
    normal::Function       = (x::Array{<:Sym,2}) -> ↑((_sympy_.Matrix((↓).(x))).XXX())
    positive_definite::Function  = (x::Array{<:Sym,2}) -> ↑((_sympy_.Matrix((↓).(x))).XXX())
    upper_triangular::Function   = (x::Array{<:Sym,2}) -> ↑((_sympy_.Matrix((↓).(x))).XXX())
    lower_triangular::Function     = (x::Array{<:Sym,2}) -> ↑((_sympy_.Matrix((↓).(x))).XXX())
    diagonal::Function     = (x::Array{<:Sym,2}) -> ↑((_sympy_.Matrix((↓).(x))).XXX())
    triangular::Function   = (x::Array{<:Sym,2}) -> ↑((_sympy_.Matrix((↓).(x))).XXX())
    square::Function       = (x::Array{<:Sym,2}) -> ↑((_sympy_.Matrix((↓).(x))).XXX())
    real_elements::Function     = (x::Array{<:Sym,2}) -> ↑((_sympy_.Matrix((↓).(x))).XXX())
    complex_elements::Function  = (x::Array{<:Sym,2}) -> ↑((_sympy_.Matrix((↓).(x))).XXX())
    integer_elements::Function  = (x::Array{<:Sym,2}) -> ↑((_sympy_.Matrix((↓).(x))).XXX())
